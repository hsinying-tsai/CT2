/********************************************************************************
** Form generated from reading UI file 'funcpar.ui'
**
...
public:
    ...
    QWidget *widget;
    QRadioButton *radioB_exposureTime;
    ...
    QRadioButton *radioB_byPassY;
    QRadioButton *radioB_overnum;
    QSpinBox *spinBox_overnum;
    QGroupBox *groupBox_2;
    QCheckBox *checkBox_separateBP;
    QLabel *label;
    QSpinBox *spinBox_ifArea;
    QLabel *label_2;
    QSpinBox *spinBox_BPBlob;
    QGroupBox *groupBox_3;
    QLabel *label_3;
    QSpinBox *spinBox_splitNum;
    QSpinBox *spinBox_edgewidth;
    QLabel *label_4;
    QSpinBox *spinBox_edgeoffset;
    QLabel *label_5;
    QLabel *label_6;
    QComboBox *comboBox_pattern_2;
    QSpinBox *spinBox_maxvalue;
    QSpinBox *spinBox_minvalue;
    QLabel *label_7;
    QLabel *MaxValue;
    QCheckBox *checkBox_pointenable;
    QCheckBox *checkBox_align;
    QCheckBox *checkBox_calibration;
    QCheckBox *checkBox_dpleakpoint;
    QCheckBox *checkBox_inversPointDefectType;
    QCheckBox *checkBox_cpdenable;
    QCheckBox *checkBox_waku;
    QCheckBox *checkBox_fixedarea;
    QWidget *tab;
    ...
    QSpinBox *spinBox_BypassUpH;
    QRadioButton *radioB_BypassDownH;
    QSpinBox *spinBox_BypassDownH;
    QSpinBox *spinBox_BypassLeftY;
    QRadioButton *radioB_BypassLeftY;
    QRadioButton *radioB_BypassRightY;
    QSpinBox *spinBox_BypassRightY;
    QRadioButton *radioB_LineCut;
    QSpinBox *spinBox_LineCut;
    QRadioButton *radioB_LineShortCut;
    QSpinBox *spinBox_LineShortCut;
    QSpinBox *spinBox_LineOverNum;
    QRadioButton *radioB_LineOverNum;
    QRadioButton *radioB_BlockOverNum;
    QSpinBox *spinBox_BlockOverNum;
    QCheckBox *checkBox_BLine;
    QGroupBox *groupBox_17;
    QSpinBox *spinBox_range;
    QSlider *horizontalSlider_range;
    QLabel *lbl_range;
    QPushButton *pushButton;
    QGroupBox *groupBox_15;
    QRadioButton *radioB_BL_threshlodHigh;
    QSpinBox *spinBox_BL_threshlodHigh;
    QSlider *horizontalSlider_BL_threshlodHigh;
    ...
    QRadioButton *radioB_DL_threshlodHigh;
    QSpinBox *spinBox_DL_threshlodHigh;
    QSlider *horizontalSlider_DL_threshlodHigh;
    ...
    void setupUi(QDialog *FuncPar)
    {
        ...
        radioB_exposureTime->setObjectName(QString::fromUtf8("radioB_exposureTime"));
        radioB_exposureTime->setGeometry(QRect(19, 34, 181, 23));
        QFont font;
        font.setPointSize(13);
        radioB_exposureTime->setFont(font);
        horizontalSlider_exposureTime = new QSlider(widget);
        horizontalSlider_exposureTime->setObjectName(QString::fromUtf8("horizontalSlider_exposureTime"));
        horizontalSlider_exposureTime->setGeometry(QRect(33, 65, 221, 21));
        horizontalSlider_exposureTime->setOrientation(Qt::Horizontal);
        spinBox_exposureTime = new QSpinBox(widget);
        spinBox_exposureTime->setObjectName(QString::fromUtf8("spinBox_exposureTime"));
        spinBox_exposureTime->setGeometry(QRect(190, 30, 61, 31));
        tabWidget->addTab(widget, QString());
        tab_2 = new QWidget();
        tab_2->setObjectName(QString::fromUtf8("tab_2"));
        groupBox = new QGroupBox(tab_2);
        groupBox->setObjectName(QString::fromUtf8("groupBox"));
        groupBox->setGeometry(QRect(20, 10, 231, 111));
        QFont font1;
        font1.setBold(false);
        font1.setWeight(50);
        groupBox->setFont(font1);
        radioB_checkDP = new QRadioButton(groupBox);
        radioB_checkDP->setObjectName(QString::fromUtf8("radioB_checkDP"));
        radioB_checkDP->setGeometry(QRect(10, 30, 112, 23));
        QFont font2;
        font2.setPointSize(13);
        font2.setBold(false);
        font2.setWeight(50);
        radioB_checkDP->setFont(font2);
        radioB_checkDP->setChecked(true);
        radioB_checkDP->setAutoExclusive(false);
        radioB_checkBP = new QRadioButton(groupBox);
        radioB_checkBP->setObjectName(QString::fromUtf8("radioB_checkBP"));
        radioB_checkBP->setGeometry(QRect(10, 55, 112, 23));
        radioB_checkBP->setFont(font2);
        radioB_checkBP->setAutoExclusive(false);
        radioB_checkDPBP = new QRadioButton(groupBox);
        radioB_checkDPBP->setObjectName(QString::fromUtf8("radioB_checkDPBP"));
        radioB_checkDPBP->setGeometry(QRect(10, 80, 112, 23));
        radioB_checkDPBP->setFont(font2);
        radioB_checkDPBP->setAutoExclusive(false);
        ...
        radioB_byPassX->setGeometry(QRect(13, 167, 161, 23));
        radioB_byPassX->setFont(font);
        radioB_byPassX->setAutoExclusive(false);
        spinBox_byPassY = new QSpinBox(groupBox_8);
        spinBox_byPassY->setObjectName(QString::fromUtf8("spinBox_byPassY"));
        spinBox_byPassY->setGeometry(QRect(160, 196, 61, 31));
        radioB_byPassY = new QRadioButton(groupBox_8);
        radioB_byPassY->setObjectName(QString::fromUtf8("radioB_byPassY"));
        radioB_byPassY->setGeometry(QRect(13, 202, 161, 23));
        radioB_byPassY->setFont(font);
        radioB_byPassY->setAutoExclusive(false);
        radioB_overnum = new QRadioButton(groupBox_8);
        radioB_overnum->setObjectName(QString::fromUtf8("radioB_overnum"));
        radioB_overnum->setGeometry(QRect(13, 235, 161, 23));
        radioB_overnum->setFont(font);
        radioB_overnum->setAutoExclusive(false);
        spinBox_overnum = new QSpinBox(groupBox_8);
        spinBox_overnum->setObjectName(QString::fromUtf8("spinBox_overnum"));
        spinBox_overnum->setGeometry(QRect(160, 230, 61, 31));
        groupBox_2 = new QGroupBox(tab_2);
        groupBox_2->setObjectName(QString::fromUtf8("groupBox_2"));
        groupBox_2->setGeometry(QRect(260, 10, 251, 111));
        checkBox_separateBP = new QCheckBox(groupBox_2);
        checkBox_separateBP->setObjectName(QString::fromUtf8("checkBox_separateBP"));
        checkBox_separateBP->setGeometry(QRect(10, 25, 161, 23));
        checkBox_separateBP->setFont(font);
        label = new QLabel(groupBox_2);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(10, 56, 67, 17));
        label->setFont(font);
        spinBox_ifArea = new QSpinBox(groupBox_2);
        spinBox_ifArea->setObjectName(QString::fromUtf8("spinBox_ifArea"));
        spinBox_ifArea->setGeometry(QRect(83, 48, 71, 31));
        label_2 = new QLabel(groupBox_2);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(10, 85, 181, 17));
        label_2->setFont(font);
        spinBox_BPBlob = new QSpinBox(groupBox_2);
        spinBox_BPBlob->setObjectName(QString::fromUtf8("spinBox_BPBlob"));
        spinBox_BPBlob->setGeometry(QRect(190, 76, 51, 31));
        groupBox_3 = new QGroupBox(tab_2);
        groupBox_3->setObjectName(QString::fromUtf8("groupBox_3"));
        groupBox_3->setGeometry(QRect(260, 310, 241, 231));
        label_3 = new QLabel(groupBox_3);
        label_3->setObjectName(QString::fromUtf8("label_3"));
        label_3->setGeometry(QRect(20, 34, 81, 17));
        label_3->setFont(font);
        spinBox_splitNum = new QSpinBox(groupBox_3);
        spinBox_splitNum->setObjectName(QString::fromUtf8("spinBox_splitNum"));
        spinBox_splitNum->setGeometry(QRect(120, 26, 61, 31));
        spinBox_edgewidth = new QSpinBox(groupBox_3);
        spinBox_edgewidth->setObjectName(QString::fromUtf8("spinBox_edgewidth"));
        spinBox_edgewidth->setGeometry(QRect(120, 60, 61, 31));
        label_4 = new QLabel(groupBox_3);
        label_4->setObjectName(QString::fromUtf8("label_4"));
        label_4->setGeometry(QRect(20, 67, 111, 17));
        label_4->setFont(font);
        spinBox_edgeoffset = new QSpinBox(groupBox_3);
        spinBox_edgeoffset->setObjectName(QString::fromUtf8("spinBox_edgeoffset"));
        spinBox_edgeoffset->setGeometry(QRect(120, 93, 61, 31));
        label_5 = new QLabel(groupBox_3);
        label_5->setObjectName(QString::fromUtf8("label_5"));
        label_5->setGeometry(QRect(20, 100, 101, 17));
        label_5->setFont(font);
        label_6 = new QLabel(groupBox_3);
        label_6->setObjectName(QString::fromUtf8("label_6"));
        label_6->setGeometry(QRect(20, 133, 141, 17));
        label_6->setFont(font);
        comboBox_pattern_2 = new QComboBox(groupBox_3);
        comboBox_pattern_2->setObjectName(QString::fromUtf8("comboBox_pattern_2"));
        comboBox_pattern_2->setGeometry(QRect(120, 127, 101, 31));
        QFont font3;
        font3.setPointSize(11);
        comboBox_pattern_2->setFont(font3);
        comboBox_pattern_2->setEditable(false);
        comboBox_pattern_2->setCurrentText(QString::fromUtf8(""));
        spinBox_maxvalue = new QSpinBox(groupBox_3);
        spinBox_maxvalue->setObjectName(QString::fromUtf8("spinBox_maxvalue"));
        spinBox_maxvalue->setGeometry(QRect(120, 193, 61, 31));
        spinBox_minvalue = new QSpinBox(groupBox_3);
        spinBox_minvalue->setObjectName(QString::fromUtf8("spinBox_minvalue"));
        spinBox_minvalue->setGeometry(QRect(120, 160, 61, 31));
        label_7 = new QLabel(groupBox_3);
        label_7->setObjectName(QString::fromUtf8("label_7"));
        label_7->setGeometry(QRect(20, 167, 111, 17));
        label_7->setFont(font);
        MaxValue = new QLabel(groupBox_3);
        MaxValue->setObjectName(QString::fromUtf8("MaxValue"));
        MaxValue->setGeometry(QRect(20, 200, 101, 17));
        MaxValue->setFont(font);
        checkBox_pointenable = new QCheckBox(tab_2);
        checkBox_pointenable->setObjectName(QString::fromUtf8("checkBox_pointenable"));
        checkBox_pointenable->setGeometry(QRect(20, 590, 161, 23));
        checkBox_pointenable->setFont(font);
        checkBox_align = new QCheckBox(tab_2);
        checkBox_align->setObjectName(QString::fromUtf8("checkBox_align"));
        checkBox_align->setGeometry(QRect(20, 620, 161, 23));
        checkBox_align->setFont(font);
        checkBox_calibration = new QCheckBox(tab_2);
        checkBox_calibration->setObjectName(QString::fromUtf8("checkBox_calibration"));
        checkBox_calibration->setGeometry(QRect(140, 590, 161, 23));
        checkBox_calibration->setFont(font);
        checkBox_dpleakpoint = new QCheckBox(tab_2);
        checkBox_dpleakpoint->setObjectName(QString::fromUtf8("checkBox_dpleakpoint"));
        checkBox_dpleakpoint->setGeometry(QRect(140, 620, 161, 23));
        checkBox_dpleakpoint->setFont(font);
        checkBox_inversPointDefectType = new QCheckBox(tab_2);
        checkBox_inversPointDefectType->setObjectName(QString::fromUtf8("checkBox_inversPointDefectType"));
        checkBox_inversPointDefectType->setGeometry(QRect(270, 550, 231, 23));
        checkBox_inversPointDefectType->setFont(font);
        checkBox_cpdenable = new QCheckBox(tab_2);
        checkBox_cpdenable->setObjectName(QString::fromUtf8("checkBox_cpdenable"));
        checkBox_cpdenable->setGeometry(QRect(270, 580, 161, 23));
        checkBox_cpdenable->setFont(font);
        checkBox_waku = new QCheckBox(tab_2);
        checkBox_waku->setObjectName(QString::fromUtf8("checkBox_waku"));
        checkBox_waku->setGeometry(QRect(270, 640, 161, 23));
        checkBox_waku->setFont(font);
        checkBox_fixedarea = new QCheckBox(tab_2);
        checkBox_fixedarea->setObjectName(QString::fromUtf8("checkBox_fixedarea"));
        checkBox_fixedarea->setGeometry(QRect(270, 610, 161, 23));
        checkBox_fixedarea->setFont(font);
        ...
        groupBox_18->setGeometry(QRect(270, 230, 251, 381));
        radioB_BypassUpH = new QRadioButton(groupBox_18);
        radioB_BypassUpH->setObjectName(QString::fromUtf8("radioB_BypassUpH"));
        radioB_BypassUpH->setGeometry(QRect(13, 35, 161, 23));
        radioB_BypassUpH->setFont(font);
        radioB_BypassUpH->setAutoExclusive(false);
        spinBox_BypassUpH = new QSpinBox(groupBox_18);
        spinBox_BypassUpH->setObjectName(QString::fromUtf8("spinBox_BypassUpH"));
        spinBox_BypassUpH->setGeometry(QRect(170, 30, 61, 31));
        radioB_BypassDownH = new QRadioButton(groupBox_18);
        radioB_BypassDownH->setObjectName(QString::fromUtf8("radioB_BypassDownH"));
        radioB_BypassDownH->setGeometry(QRect(13, 80, 161, 23));
        radioB_BypassDownH->setFont(font);
        radioB_BypassDownH->setAutoExclusive(false);
        spinBox_BypassDownH = new QSpinBox(groupBox_18);
        spinBox_BypassDownH->setObjectName(QString::fromUtf8("spinBox_BypassDownH"));
        spinBox_BypassDownH->setGeometry(QRect(170, 75, 61, 31));
        spinBox_BypassLeftY = new QSpinBox(groupBox_18);
        spinBox_BypassLeftY->setObjectName(QString::fromUtf8("spinBox_BypassLeftY"));
        spinBox_BypassLeftY->setGeometry(QRect(170, 120, 61, 31));
        radioB_BypassLeftY = new QRadioButton(groupBox_18);
        radioB_BypassLeftY->setObjectName(QString::fromUtf8("radioB_BypassLeftY"));
        radioB_BypassLeftY->setGeometry(QRect(13, 125, 161, 23));
        radioB_BypassLeftY->setFont(font);
        radioB_BypassLeftY->setAutoExclusive(false);
        radioB_BypassRightY = new QRadioButton(groupBox_18);
        radioB_BypassRightY->setObjectName(QString::fromUtf8("radioB_BypassRightY"));
        radioB_BypassRightY->setGeometry(QRect(13, 170, 161, 23));
        radioB_BypassRightY->setFont(font);
        radioB_BypassRightY->setAutoExclusive(false);
        spinBox_BypassRightY = new QSpinBox(groupBox_18);
        spinBox_BypassRightY->setObjectName(QString::fromUtf8("spinBox_BypassRightY"));
        spinBox_BypassRightY->setGeometry(QRect(170, 165, 61, 31));
        radioB_LineCut = new QRadioButton(groupBox_18);
        radioB_LineCut->setObjectName(QString::fromUtf8("radioB_LineCut"));
        radioB_LineCut->setGeometry(QRect(13, 215, 161, 23));
        radioB_LineCut->setFont(font);
        radioB_LineCut->setAutoExclusive(false);
        spinBox_LineCut = new QSpinBox(groupBox_18);
        spinBox_LineCut->setObjectName(QString::fromUtf8("spinBox_LineCut"));
        spinBox_LineCut->setGeometry(QRect(170, 210, 61, 31));
        radioB_LineShortCut = new QRadioButton(groupBox_18);
        radioB_LineShortCut->setObjectName(QString::fromUtf8("radioB_LineShortCut"));
        radioB_LineShortCut->setGeometry(QRect(13, 260, 161, 23));
        radioB_LineShortCut->setFont(font);
        radioB_LineShortCut->setAutoExclusive(false);
        spinBox_LineShortCut = new QSpinBox(groupBox_18);
        spinBox_LineShortCut->setObjectName(QString::fromUtf8("spinBox_LineShortCut"));
        spinBox_LineShortCut->setGeometry(QRect(170, 255, 61, 31));
        spinBox_LineOverNum = new QSpinBox(groupBox_18);
        spinBox_LineOverNum->setObjectName(QString::fromUtf8("spinBox_LineOverNum"));
        spinBox_LineOverNum->setGeometry(QRect(170, 300, 61, 31));
        radioB_LineOverNum = new QRadioButton(groupBox_18);
        radioB_LineOverNum->setObjectName(QString::fromUtf8("radioB_LineOverNum"));
        radioB_LineOverNum->setGeometry(QRect(13, 305, 161, 23));
        radioB_LineOverNum->setFont(font);
        radioB_LineOverNum->setAutoExclusive(false);
        radioB_BlockOverNum = new QRadioButton(groupBox_18);
        radioB_BlockOverNum->setObjectName(QString::fromUtf8("radioB_BlockOverNum"));
        radioB_BlockOverNum->setGeometry(QRect(13, 350, 161, 23));
        radioB_BlockOverNum->setFont(font);
        radioB_BlockOverNum->setAutoExclusive(false);
        spinBox_BlockOverNum = new QSpinBox(groupBox_18);
        spinBox_BlockOverNum->setObjectName(QString::fromUtf8("spinBox_BlockOverNum"));
        ...
        spinBox_range = new QSpinBox(groupBox_17);
        spinBox_range->setObjectName(QString::fromUtf8("spinBox_range"));
        spinBox_range->setGeometry(QRect(181, 30, 61, 31));
        horizontalSlider_range = new QSlider(groupBox_17);
        horizontalSlider_range->setObjectName(QString::fromUtf8("horizontalSlider_range"));
        horizontalSlider_range->setGeometry(QRect(10, 90, 221, 21));
        horizontalSlider_range->setOrientation(Qt::Horizontal);
        lbl_range = new QLabel(groupBox_17);
        lbl_range->setObjectName(QString::fromUtf8("lbl_range"));
        lbl_range->setGeometry(QRect(10, 30, 91, 31));
        lbl_range->setFont(font);
        ...
        radioB_BL_threshlodHigh->setFont(font);
        radioB_BL_threshlodHigh->setAutoExclusive(false);
        spinBox_BL_threshlodHigh = new QSpinBox(groupBox_15);
        spinBox_BL_threshlodHigh->setObjectName(QString::fromUtf8("spinBox_BL_threshlodHigh"));
        spinBox_BL_threshlodHigh->setGeometry(QRect(181, 30, 61, 31));
        horizontalSlider_BL_threshlodHigh = new QSlider(groupBox_15);
        horizontalSlider_BL_threshlodHigh->setObjectName(QString::fromUtf8("horizontalSlider_BL_threshlodHigh"));
        horizontalSlider_BL_threshlodHigh->setGeometry(QRect(24, 65, 221, 21));
        horizontalSlider_BL_threshlodHigh->setOrientation(Qt::Horizontal);
        radioB_BL_threshlodLow = new QRadioButton(groupBox_15);
        radioB_BL_threshlodLow->setObjectName(QString::fromUtf8("radioB_BL_threshlodLow"));
        radioB_BL_threshlodLow->setGeometry(QRect(6, 109, 181, 23));
        radioB_BL_threshlodLow->setFont(font);
        radioB_BL_threshlodLow->setAutoExclusive(false);
        horizontalSlider_BL_threshlodLow = new QSlider(groupBox_15);
        horizontalSlider_BL_threshlodLow->setObjectName(QString::fromUtf8("horizontalSlider_BL_threshlodLow"));
        horizontalSlider_BL_threshlodLow->setGeometry(QRect(20, 140, 221, 21));
        horizontalSlider_BL_threshlodLow->setOrientation(Qt::Horizontal);
        ...
        radioB_DL_threshlodHigh->setFont(font);
        radioB_DL_threshlodHigh->setAutoExclusive(false);
        spinBox_DL_threshlodHigh = new QSpinBox(groupBox_16);
        spinBox_DL_threshlodHigh->setObjectName(QString::fromUtf8("spinBox_DL_threshlodHigh"));
        spinBox_DL_threshlodHigh->setGeometry(QRect(181, 30, 61, 31));
        horizontalSlider_DL_threshlodHigh = new QSlider(groupBox_16);
        horizontalSlider_DL_threshlodHigh->setObjectName(QString::fromUtf8("horizontalSlider_DL_threshlodHigh"));
        horizontalSlider_DL_threshlodHigh->setGeometry(QRect(24, 65, 221, 21));
        horizontalSlider_DL_threshlodHigh->setOrientation(Qt::Horizontal);
        radioB_DL_threshlodLow = new QRadioButton(groupBox_16);
        radioB_DL_threshlodLow->setObjectName(QString::fromUtf8("radioB_DL_threshlodLow"));
        radioB_DL_threshlodLow->setGeometry(QRect(6, 109, 181, 23));
        radioB_DL_threshlodLow->setFont(font);
        radioB_DL_threshlodLow->setAutoExclusive(false);
        horizontalSlider_DL_threshlodLow = new QSlider(groupBox_16);
        horizontalSlider_DL_threshlodLow->setObjectName(QString::fromUtf8("horizontalSlider_DL_threshlodLow"));
        horizontalSlider_DL_threshlodLow->setGeometry(QRect(20, 140, 221, 21));
        horizontalSlider_DL_threshlodLow->setOrientation(Qt::Horizontal);
    ...
    void retranslateUi(QDialog *FuncPar)
    {
        FuncPar->setWindowTitle(QApplication::translate("FuncPar", "Dialog", nullptr));
        radioB_exposureTime->setText(QApplication::translate("FuncPar", "exposure Time (s) :", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(widget), QApplication::translate("FuncPar", "\351\240\201\351\235\242", nullptr));
        groupBox->setTitle(QApplication::translate("FuncPar", "Point Mode\357\274\232", nullptr));
        ...
        radioB_checkDPBP->setText(QApplication::translate("FuncPar", "\346\252\242\346\237\245DP+BP", nullptr));
        ...
        groupBox_2->setTitle(QApplication::translate("FuncPar", "Separate BP", nullptr));
        checkBox_separateBP->setText(QApplication::translate("FuncPar", "Use Separate BP", nullptr));
        label->setText(QApplication::translate("FuncPar", "if Area >", nullptr));
        label_2->setText(QApplication::translate("FuncPar", "separate BP with Blob", nullptr));
        groupBox_3->setTitle(QApplication::translate("FuncPar", "Waku Setting", nullptr));
        label_3->setText(QApplication::translate("FuncPar", "Split Num", nullptr));
        label_4->setText(QApplication::translate("FuncPar", "Edge Width", nullptr));
        label_5->setText(QApplication::translate("FuncPar", "Edge Offset", nullptr));
        label_6->setText(QApplication::translate("FuncPar", "current side", nullptr));
        label_7->setText(QApplication::translate("FuncPar", "Min Value", nullptr));
        MaxValue->setText(QApplication::translate("FuncPar", "MaxValue", nullptr));
        checkBox_pointenable->setText(QApplication::translate("FuncPar", "\346\252\242\346\237\245Enable", nullptr));
        checkBox_align->setText(QApplication::translate("FuncPar", "Align", nullptr));
        checkBox_calibration->setText(QApplication::translate("FuncPar", "Calibration", nullptr));
        checkBox_dpleakpoint->setText(QApplication::translate("FuncPar", "DP LeakPoint", nullptr));
        checkBox_inversPointDefectType->setText(QApplication::translate("FuncPar", "Inverse Point Defect Type", nullptr));
        checkBox_cpdenable->setText(QApplication::translate("FuncPar", "CPD Eable", nullptr));
        checkBox_waku->setText(QApplication::translate("FuncPar", "Waku\346\252\242\346\270\254", nullptr));
        ...
        radioB_BypassDownH->setText(QApplication::translate("FuncPar", "Bypass Down H", nullptr));
        radioB_BypassLeftY->setText(QApplication::translate("FuncPar", "Bypass Left Y", nullptr));
        radioB_BypassRightY->setText(QApplication::translate("FuncPar", "Bypass Right Y", nullptr));
        radioB_LineCut->setText(QApplication::translate("FuncPar", "Line Cut", nullptr));
        radioB_LineShortCut->setText(QApplication::translate("FuncPar", "Line Short Cut", nullptr));
        radioB_LineOverNum->setText(QApplication::translate("FuncPar", "Line Over Num", nullptr));
        radioB_BlockOverNum->setText(QApplication::translate("FuncPar", "Block Over Num", nullptr));
        checkBox_BLine->setText(QApplication::translate("FuncPar", "BLine Enable", nullptr));
        groupBox_17->setTitle(QApplication::translate("FuncPar", "Mean Difference", nullptr));
        lbl_range->setText(QApplication::translate("FuncPar", "Range\357\274\232", nullptr));
        pushButton->setText(QApplication::translate("FuncPar", "\345\217\203\350\200\203range", nullptr));
...
namespace Ui {
    class FuncPar: public Ui_FuncPar {};
} // namespace Ui
