...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        list_Pattern->setGeometry(QRect(35, 30, 311, 501));
...
"background-color: red;"));
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        comboBox_pattern->setItemText(1, QString());
