...
QT_MOC_LITERAL(1, 11, 11), // "recv_update"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 16) // "connect_UIupdate"

    },
    "tcp_client\0recv_update\0\0connect_UIupdate"
};
...
void tcp_client::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->recv_update((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->connect_UIupdate(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (tcp_client::*)(const QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&tcp_client::recv_update)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&tcp_client::connect_UIupdate)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void tcp_client::recv_update(const QString _t1)
{
...
// SIGNAL 1
void tcp_client::connect_UIupdate()
{
