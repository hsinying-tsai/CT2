...
QT_MOC_LITERAL(1, 10, 9), // "Mouse_Pos"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 8), // "set_pic2"
QT_MOC_LITERAL(4, 30, 16), // "rectangleClicked"
QT_MOC_LITERAL(5, 47, 5) // "index"

    },
    "my_qlabel\0Mouse_Pos\0\0set_pic2\0"
    "rectangleClicked\0index"
};
...
void my_qlabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->Mouse_Pos();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 1: { int _r = _t->set_pic2((*reinterpret_cast< const int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 2: _t->rectangleClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = int (my_qlabel::*)();
        ...
        {
            using _t = int (my_qlabel::*)(const int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&my_qlabel::set_pic2)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (my_qlabel::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&my_qlabel::rectangleClicked)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
int my_qlabel::set_pic2(const int _t1)
{
    int _t0{};
...
// SIGNAL 2
void my_qlabel::rectangleClicked(int _t1)
{
